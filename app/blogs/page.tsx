          ...
          <div className="container">
            ...
            >
              ...
              >
                ...
                >
                  You can also check out my latest thoughts, technical articles,
                  and tutorials on these platforms.
                </p>
                <div
                  style={{
                    display: "flex",
                ...
                >
                  <a
                    href="https://rivesh.hashnode.dev/"
                    target="_blank"
                  ...
                  <a
                    href="https://medium.com/@rivesh-kumar"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn btn-primary"
                    style={{
        ...
        <section className="section" style={{ paddingTop: "20px" }}>
          <div className="container">
            ...
            >
              ...
              >
                A collection of my thoughts, tutorials, and deep dives into
                software engineering, web development, and modern design.
              </p>
            </div>
