  ...
  return (
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {children ? (
          <ParticleCard
            className={`card flex flex-col justify-between relative w-full p-5 rounded-[20px] border border-solid font-light overflow-hidden transition-colors duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${
